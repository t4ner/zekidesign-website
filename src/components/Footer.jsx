...
import Logo from "/logo/logo2.png"; // Logo'yu assets klasörüne eklemelisiniz
      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-col justify-center gap-6 mb-8 md:mb-16 md:flex-row md:gap-16">
          <a href="tel:+4901733123222" className="flex items-center gap-4">
            ...
            <span className="text-base md:text-lg font-medium text-[#06234B]">
              0173-31 23 222
            </span>
          </a>
          ...
          >
            ...
            <span className="text-base md:text-lg font-medium text-[#06234B]">WhatsApp</span>
          </a>
        </div>
        ...
        <div className="text-center md:mb-10">
          ...
          <h2 className="text-xl md:text-3xl font-bold text-[#06234B] mt-2">
