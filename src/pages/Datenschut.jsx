  ...
  return (
    <div className="container px-4 py-8 mx-auto mb-10 md:mb-20 md:mt-16">
      ...
      <div className="pl-6 mt-5 text-xs text-zinc-500 md:text-base">
        ...
        <ol className="pl-6 ml-6 ">
          <li>
            Durch direkte Eingabe durch Sie, z. B. in einem Kontaktformular.
          </li>
          <li>
            Automatisch durch unsere IT-Systeme, wenn Sie die Website nutzen (z.
            B. technische Daten wie Browsertyp, Betriebssystem, Uhrzeit des
            Seitenaufrufs).
          </li>
        </ol>
      </div>
      ...
      <div className="pl-6 mt-5 text-xs text-zinc-500 md:text-base">
        ...
        Außerdem haben Sie das Recht, eine Beschwerde bei der zuständigen
      ...
      <div className="text-xs text-zinc-500 md:text-base">
        ...
        <ul className="mt-2 ml-6 ">
          <li>
            ...
            Werden nach dem Verlassen der Website automatisch gelöscht.
          </li>
          <li>
            <span className="font-medium text-[#06234B]">
              • Persistente Cookies:
      ...
      <div className="my-2 text-xs text-zinc-500 md:text-base">
        ...
        Cookies informiert werden und Cookies nur im Einzelfall erlauben. Eine
      ...
      <div className="text-xs text-zinc-500 md:text-base">
        ...
        aufgrund des berechtigten Interesses des Websitebetreibers, eine
        technisch fehlerfreie und optimierte Bereitstellung seiner Dienste zu
        gewährleisten.
      </div>
      ...
      <div className="text-xs text-zinc-500 md:text-base">
        ...
        <br />
        Unsere Website verwendet Google Fonts, die lokal gespeichert sind. Es
      ...
      <div className="text-xs text-zinc-500 md:text-base">
        ...
        zur ansprechenden Darstellung unseres Online-Angebots und zur leichten
        Auffindbarkeit der auf der Website angegebenen Orte beiträgt. Weitere
      ...
      <div className="text-xs text-zinc-500 md:text-base">
        ...
        in dem Mitgliedstaat Ihres gewöhnlichen Aufenthaltsortes, Ihres
